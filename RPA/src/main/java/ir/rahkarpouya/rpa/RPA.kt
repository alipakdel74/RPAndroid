...
import ir.rahkarpouya.rpa.dialog.MessageDialog
import ir.rahkarpouya.rpa.dialog.QuestionDialog
...
object RPA {
    ...
    object Message {
        ...
        fun showMessage(
            ...
            @ColorRes backgroundColorSnack: Int = android.R.color.holo_red_dark,
        ...
        fun showMessage(
            ...
            @ColorRes backgroundColorSnack: Int = android.R.color.holo_red_dark,
            @ColorRes textColorSnack: Int = android.R.color.white,
            @ColorRes textColorActionSnack: Int = android.R.color.holo_red_dark
        ) {
        ...
        fun messageToast(
            ...
            recourseBackground: Int = android.R.color.holo_red_dark,
